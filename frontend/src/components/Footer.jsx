...
function Footer() {
    ...
    return (
        <footer style={{ background: "#000000", color: "#fff", padding: "30px 20px 15px", marginTop: "40px" }}>
            <div style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
                ...
                <p style={{ fontSize: "11px", color: "#666", margin: 0 }}>© {new Date().getFullYear()} Pardo Agenda - Manuel Casimiro Carrasco - Reus, Tarragona</p>
            </div>
            {showOwner && (
                <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.8)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 3000, padding: "20px" }} onClick={() => setShowOwner(false)}>
